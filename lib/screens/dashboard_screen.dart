...
class _DashboardScreenState extends State<DashboardScreen>
            ...
            children: [
              Row(
                ...
                children: [
                  Row(
                    children: [
                      Container(
                        ...
                        child: PhosphorIcon(PhosphorIcons.shieldPlus(), color: Colors.white, size: 20),
                      ),
                  ...
                  Row(
                    children: [
                      _headerIconBtn(PhosphorIcons.bell(), badge: true, onTap: () => Navigator.push(
                        context,
                        MaterialPageRoute(builder: (_) => const NotificationPage()),
                      )),
                      const SizedBox(width: 4),
                      _headerIconBtn(PhosphorIcons.plus(), onTap: () => setState(() { _prevNavIndex = _bottomNavIndex; _bottomNavIndex = 1; })),
                    ],
                  ),
                ],
              ),
              ...
              Row(
                children: [
                  Container(
                    ...
                    child: PhosphorIcon(PhosphorIcons.user(), color: Colors.white, size: 26),
                  ),
                  ...
                  Container(
                    ...
                    child: Row(
                      children: [
                        PhosphorIcon(PhosphorIcons.calendarBlank(), color: Colors.white70, size: 13),
  ...
  Widget _headerIconBtn(PhosphorIconData icon, {bool badge = false, VoidCallback? onTap}) {
    return Stack(
  ...
  Widget _buildActionChips() {
    return Row(
      children: [
        _chip(PhosphorIcons.bellSimple(), 'Alerts', const Color(0xFFFF6B35), hasBadge: true,
            onTap: () => setState(() { _prevNavIndex = _bottomNavIndex; _bottomNavIndex = 2; })),
        const SizedBox(width: 10),
        _chip(PhosphorIcons.chartLineUp(), 'Progress', const Color(0xFF4A90D9),
            onTap: () => setState(() { _prevNavIndex = _bottomNavIndex; _bottomNavIndex = 1; })),
        const SizedBox(width: 10),
        _chip(PhosphorIcons.playCircle(), 'Demo', const Color(0xFFE53935),
  ...
  Widget _chip(PhosphorIconData icon, String label, Color color, {bool hasBadge = false, VoidCallback? onTap}) {
    return Expanded(
                  ...
                  children: [
                    AnimatedContainer(
                      ...
                      decoration: BoxDecoration(
                        ...
                        shape: BoxShape.circle,
                        boxShadow: checked
                            ? [BoxShadow(color: primaryTeal.withValues(alpha: 0.4), blurRadius: 10, offset: const Offset(0, 4))]
                            : null,
                      ),
                      child: Center(
                        child: checked
  ...
  Widget _buildStatsRow() {
    return Row(
      children: [
        _buildStatCard('Active Days', '3', '+2', PhosphorIcons.calendarCheck(), const Color(0xFFFF6B35)),
        const SizedBox(width: 10),
        _buildStatCard('Sessions', '2', '+2', PhosphorIcons.heartbeat(), primaryTeal),
        const SizedBox(width: 10),
        _buildStatCard('Time', '42m', '89%', PhosphorIcons.timer(), const Color(0xFF7C4DFF)),
      ],
    );
  }

  Widget _buildStatCard(String label, String value, String sub, PhosphorIconData icon, Color color) {
    return Expanded(
      child: Container(
          ...
          children: [
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  const PhosphorIcon(PhosphorIconsRegular.arrowUp, size: 10, color: Colors.green),
                  const SizedBox(width: 2),
                  Text(sub, style: const TextStyle(fontSize: 10, color: Colors.green, fontWeight: FontWeight.w700)),
                ],
              ),
            ),
          ],
      ...
      child: Row(
        ...
        children: [
          Container(
            ...
            child: const PhosphorIcon(PhosphorIconsRegular.quotes, color: Colors.white, size: 22),
          ),
          const SizedBox(width: 14),
          const Expanded(
            child: Column(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              PhosphorIcon(PhosphorIcons.stethoscope(), color: primaryTeal, size: 16),
          ...
          Row(
            children: [
              Stack(
                children: [
                  Container(
                    ...
                    height: 58,
                    decoration: BoxDecoration(
                      gradient: const LinearGradient(colors: [lightTealBg, Color(0xFFB2DFDB)]),
                      shape: BoxShape.circle,
                    ),
                    child: const PhosphorIcon(PhosphorIconsRegular.user, size: 30, color: primaryTeal),
                  ),
                  Positioned(
                    bottom: 2,
                    right: 2,
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text('Physical Therapist', style: TextStyle(fontSize: 12, color: Colors.grey.shade500)),
                    ...
                    Row(
                      children: [
                        ...
                        const SizedBox(width: 5),
                        const Text('Available now', style: TextStyle(fontSize: 11, color: Color(0xFF4CAF50), fontWeight: FontWeight.w600)),
                      ],
                    ),
                  ],
                ),
              ...
              ElevatedButton(
                onPressed: () => setState(() { _prevNavIndex = _bottomNavIndex; _bottomNavIndex = 2; }),
                ...
                child: const Text('Contact', style: TextStyle(fontSize: 13, fontWeight: FontWeight.w700, color: Colors.white)),
              ),
            ],
          ),
        ],
        ...
        child: Padding(
          ...
          child: Row(
            ...
            children: List.generate(items.length, (i) {
              ...
              return GestureDetector(
                onTap: () => setState(() { _prevNavIndex = _bottomNavIndex; _bottomNavIndex = i; }),
                child: AnimatedContainer(
                  ...
                  child: Row(
                    children: [
                      PhosphorIcon(items[i].$1, size: 22, color: selected ? Colors.white : Colors.grey.shade400),
                      if (selected) ...[
                        const SizedBox(width: 6),
                        Text(
                          items[i].$2,
